        ...
        <div className="mt-20 space-y-8">
          {[
            ...
            <motion.div
              ...
              className="flex items-center gap-6 rounded-2xl border border-[#e3e2de] bg-[#f7f7f5] p-6"
            >
              <item.icon className="h-5 w-5 text-[#14804f]" />
              <div>
                <p className="text-xs uppercase tracking-wider text-[#888]">{item.label}</p>
                <p className="mt-1 text-lg text-[#111]">{item.value}</p>
              </div>
            </motion.div>
          ))}
        </div>
